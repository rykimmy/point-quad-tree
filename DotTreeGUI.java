...
public class DotTreeGUI extends DrawingGUI {
	...
	private void test2() {
		found = null;
		tree = new PointQuadtree<Dot>(new Dot(400,300), 0,0,800,600);
		tree.insert(new Dot(100,400));
		tree.insert(new Dot(220,600));
		tree.insert(new Dot(500,210));
		tree.insert(new Dot(380,500));
		tree.insert(new Dot(200,40));
		int bad = 0;
		bad += testFind(100,405,10,6,3,1);
		bad += testFind(250,500,20,6,4,0);
		bad += testFind(600,200,70,4,2,0);
		bad += testFind(420,550,80,6,4,1);
		bad += testFind(200,500,800,6,6,6);
